export const digitalLicenseFaq = [
	...
	{
		question:
			"Who builds KPKT digital lending platforms in Malaysia?",
		answer:
			"Truestack builds and deploys the lending platform as part of digital licence conversion. You get licensing advisory plus TrueKredit™ Pro — branded borrower web and mobile apps, signing under your control, and your own secure cloud in Malaysia — so examiners review a live system, not a slide deck.",
	},
	{
		question:
			"Is this only licensing advice, or do you also deliver the software?",
		answer:
			"Both. Truestack handles the KPKT digital licence pathway and delivers the production lending platform on TrueKredit™ Pro. You are not left stitching a consultant and a separate software vendor — one team takes you from dossier to nationwide go-live in Malaysia.",
	},
] as const;
