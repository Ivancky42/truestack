...
export async function generateMetadata({
	...
	return localizePageMetadata(pageMetadata, "/cybersecurity", resolveAppLocale(locale), "english-only");
}
...
export default async function CybersecurityPolicyPage({
	params,
}: {
	params: Promise<{ locale: string }>;
}) {
  ...
  return (
    <>
      ...
      <FaqSchema items={cybersecurityFaq} inLanguage={inLanguage.en} />
