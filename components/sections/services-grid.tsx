		...
		>
			...
			>
				<CardHeader>
					...
					>
						<Icon
							className={`h-6 w-6 ${isKpkt ? "text-kpkt" : "text-primary"}`}
						/>
					</motion.div>
		...
		<section className="py-20">
			<div className="mx-auto max-w-6xl px-6">
				<SectionHeader
					...
					subtitle="From compliance management to software development — everything you need to run and grow your lending business. Tailored to your unique business needs."
				/>
