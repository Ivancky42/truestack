	...
	return (
		...
		>
			<div className="relative aspect-square overflow-hidden rounded-[2rem] border border-emerald-200/70 bg-linear-to-br from-emerald-50 via-white to-amber-50/90 shadow-[0_24px_80px_-24px_rgba(5,150,105,0.35)]">
				...
				>
					<div className="relative aspect-[9/18.5] rounded-[1.35rem] bg-slate-900 p-[5px] shadow-2xl shadow-emerald-950/30 ring-1 ring-slate-700/80">
						<div
				...
				<div
					className="pointer-events-none absolute bottom-[2%] left-1/2 h-8 w-[70%] -translate-x-1/2 rounded-full bg-emerald-400/20 blur-xl"
					aria-hidden
				/>
			</div>
		</motion.div>
